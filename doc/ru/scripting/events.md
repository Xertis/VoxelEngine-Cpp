...
- [События контента](#события-контента)
...
| --------------- | ---------------------------------------------------------------------------- | -------------------------------------------------------- |
| `(0) PUT`       | Кладёт все предметы в слот, если другой предмет в слоте - обмен              | Кладёт в слот один предмет из слота курсора              |
| `(1) TAKE`      | Забирает все предметы из слота                                               | Берёт половину предметов из слота (округление вверх)     |
| `(2) SHARE`     | Вызывает share ивент у макета инвентаря                                      | Не определён                                             |
